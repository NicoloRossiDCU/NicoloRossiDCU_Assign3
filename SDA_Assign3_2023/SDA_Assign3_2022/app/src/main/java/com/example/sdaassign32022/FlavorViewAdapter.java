...
public class FlavorViewAdapter extends RecyclerView.Adapter<FlavorViewAdapter.ViewHolder> {
    ...
    private ArrayList<TSDesignAdapter> mFlavors;

    FlavorViewAdapter(Context mNewContext, ArrayList<TSDesignAdapter> mflavor, OnItemListener mOnItemListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.imageText.setText(mFlavors.get(position).getAvailableSize());
        viewHolder.sizeText.setText(mFlavors.get(position).getVersionName());
    ...
    // ViewHolder class
    // Implements OnClickListener to listen to click events
