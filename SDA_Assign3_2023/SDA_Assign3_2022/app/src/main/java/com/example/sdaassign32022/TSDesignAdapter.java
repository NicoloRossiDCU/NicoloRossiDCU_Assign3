...
/**
 * {@link TSDesignAdapter} represents a single Design art for a t-shirt.
 * Each object has 3 properties: name, size, and image resource ID.
 * This is a basic arrayAdapter
 */
public class TSDesignAdapter {
     ...
     *
     * */
    public TSDesignAdapter(String vName, String sizes, int imageResourceId)
    {
        mVersionName = vName;
        mSizes = sizes;
